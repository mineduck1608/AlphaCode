...
@router.get("/{ca_id}", response_model=ConversationAgent)
...
@router.get("/conversation/{conversation_id}", response_model=List[ConversationAgent])
...
@router.get("/agent/{agent_id}", response_model=List[ConversationAgent])
...
@router.get("/conversation/{conversation_id}/active", response_model=List[ConversationAgent])
...
@router.put("/{ca_id}", response_model=ConversationAgent)
...
@router.post("/conversation/{conversation_id}/switch/{agent_id}", response_model=ConversationAgent)
